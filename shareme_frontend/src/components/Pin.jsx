          ...
          >
            <div className="flex flex-items justify-between">
              <div className="flex gap-2">
                ...
                >
                  <MdDownloadForOffline className="text-gray-600 text-xl" />
                </a>
              </div>
              {alreadySaved ? (
                <button 
                  type="button" 
                  className="bg-accentColor opacity-75 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none"
                >
                  {save?.length} Salvo
                </button>
              ):(
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                ...
                >
                  <BsFillArrowUpRightCircleFill className="text-gray-600 text-xl" />
